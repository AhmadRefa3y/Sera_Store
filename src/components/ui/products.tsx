    ...
    return (
        <div className="flex items-center justify-center h-full gap-2 flex-wrap ">
            {products.map((product) => (
                <div className="w-[350px] group h-[400px] p-2  rounded-md flex items-center flex-col overflow-hidden">
                    <div
                        key={product.id}
                    ...
                    >
                        ...
                        />
                        <div className="flex items-center justify-center absolute bottom-3 w-full gap-3">

...
const AddToCartButton = ({ product, mode }: props) => {
    const cart = useCart();
    ...
    return (
        ...
        >
            {mode === "desktop" ? (
                <div className="p-2 bg-white rounded-full flex items-center justify-center hover:bg-slate-600 hover:text-white hover:scale-125 duration-300">
                    <svg

...
const Footer = () => {
    return (
        <div className="bg-[#e4e4e4] w-full h-fit flex flex-wrap md:flex-row sm:justify-between items-center p-7 ">
            <div className="flex flex-1 flex-wrap md:gap-40 gap-2 items-center">
                <div
                    className=" font-normal gap-2  text-xs  flex items-start flex-col justify-start py-4
               px-4 "
                >
